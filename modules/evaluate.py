...
from plotting import plot_rse_in_time
...
def evaluate_data(log, output_folder, g_u_scaler, x_len, t_len, g_u_train, g_u_pred_train, g_u_test, g_u_pred_test):
    ...
    plot_rse_in_time(g_u=outputs[2], g_u_pred=outputs[3].numpy(), t_len=t_len, output_folder=output_folder, plot_name="rse_in_time")
